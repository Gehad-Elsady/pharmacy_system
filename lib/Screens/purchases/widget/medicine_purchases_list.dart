...
class MedicinePurchasesList extends StatefulWidget {
  const MedicinePurchasesList({super.key});

  @override
  State<MedicinePurchasesList> createState() => _MedicinePurchasesListState();
}

class _MedicinePurchasesListState extends State<MedicinePurchasesList> {
  String query = "";
                ...
                builder: (context, snapshot) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        onTap: () async {
                          await FirebaseFunctions.addMedicinesToPurchases(
                              medicien);
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              backgroundColor: Colors.green,
                              content: Text("Medicine added to purchases."),
